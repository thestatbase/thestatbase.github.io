...
description: Residual-based potential framework applied to running backs using a volume index that properly accounts for fantasy value in volume-driven statistics.
---

<div class="breadcrumb">
  <a href="{{ '/' | relative_url }}">StatBase</a> <span>/</span> <a href="{{ '/projects/' | relative_url }}">Projects</a> <span>/</span> RB Potential
</div>

<div class="page-header">
  <div class="page-category">NFL · Running Backs</div>
...
## Running Back Potential Charts for the 2025–26 NFL Season

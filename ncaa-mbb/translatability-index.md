...
<div class="breadcrumb">
  <a href="{{ '/' | relative_url }}">StatBase</a> <span>/</span> <a href="{{ '/projects/' | relative_url }}">Projects</a> <span>/</span> Translatability Index
</div>

<div class="page-header">
  <div class="page-category ncaa">NCAA Men's Basketball · Methodology</div>
  <h1>Translatability Index (TI)</h1>
  <div class="page-meta">Applied across: <a href="{{ '/ncaa-mbb/up-down-up-transfers/' | relative_url }}">Up-Down-Up Transfers</a> · <a href="{{ '/ncaa-mbb/d2-to-d1-transfers/' | relative_url }}">D2-to-D1 Transfers</a></div>
</div>
...
**Volume Appropriateness (10%)** penalizes usage rates that fall significantly outside the 18-22% sweet spot, with the score peaking at 20% USG% and falling symmetrically in both directions. Extreme usage in either direction reliably signals a player whose role will not translate cleanly to the next level.
...
To see how this works, consider Very Low TI players in the Up-Down-Up dataset (n=32). They averaged a Phase 2 WARP/40 of -0.090, meaning they were poor contributors at the down school. Their Phase 3 WARP/40 only needs to beat -0.090 minus 0.005, or -0.095, to count as success. Their actual average Phase 3 WARP/40 is -0.018, which comfortably clears that threshold, producing a 71.9% success rate. The important detail is that -0.018 is still a very poor Phase 3 WARP/40. These players cleared the bar, but they are still bad players.
...
<table class="data-table">
  ...
  <tbody>
    ...
    <tr><td class="highlight">High</td><td>65–80</td><td>99</td><td>25.3%</td><td>+0.203</td><td>+0.123</td></tr>
    <tr><td class="highlight">Moderate</td><td>50–65</td><td>187</td><td>39.0%</td><td>+0.114</td><td>+0.070</td></tr>
    <tr><td class="highlight">Low</td><td>35–50</td><td>164</td><td>60.4%</td><td>+0.001</td><td>+0.009</td></tr>
    <tr><td class="highlight">Very Low</td><td>0–35</td><td>32</td><td>71.9%</td><td>−0.090</td><td>−0.018</td></tr>
  </tbody>
</table>
</div>
...
<table class="data-table">
  ...
  <tbody>
    ...
    <tr><td class="highlight">High</td><td>65–80</td><td>141</td><td>5.0%</td><td>+0.21</td><td>+0.080</td></tr>
    <tr><td class="highlight">Moderate</td><td>50–65</td><td>221</td><td>11.3%</td><td>+0.13</td><td>+0.042</td></tr>
    <tr><td class="highlight">Low</td><td>35–50</td><td>157</td><td>29.3%</td><td>+0.04</td><td>−0.032</td></tr>
    <tr><td class="highlight">Very Low</td><td>0–35</td><td>39</td><td>46.2%</td><td>−0.04</td><td>−0.016</td></tr>
  </tbody>
</table>
</div>
...
Individual component correlations against Phase 2 WARP/40 in the D2-to-D1 population show System Fit as the strongest standalone component (r = 0.426), followed by Efficiency (r = 0.336). Jump Risk (r = -0.060), Trajectory (r = -0.081), and Volume (r = +0.019) do not reach significance on their own, though all three contribute to the composite. The fact that System Fit is the strongest individual component means that the archetype-to-system match is worth modeling explicitly and is not simply a qualitative consideration to be discussed after the statistical evaluation is complete.
